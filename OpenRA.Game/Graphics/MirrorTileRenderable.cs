...
{
	public class MirrorTileRenderable : IRenderable, IFinalizedRenderable
	{
		readonly CPos pos;
		readonly Color color;

		public MirrorTileRenderable(CPos pos, Color color)
		{
			this.pos = pos;
			this.color = color;
		}
		...
		{
			return new MirrorTileRenderable(pos, color);
		}
