...
namespace OpenRA.Mods.Common.Graphics
{
	...
	public class EditorSelectionAnnotationRenderable : IRenderable, IFinalizedRenderable
	{
		...
		public void Render(WorldRenderer wr)
		{
			...
			var destWPos = offset.HasValue ? map.CenterOfCell(offset.Value) : originalWPos;
			var wposOffset = destWPos - originalWPos;
			...
			foreach (var cellPos in bounds.CellCoords)
			{
				...
				var pos = map.CenterOfCell(cellPos) - new WVec(0, 0, r.CenterHeightOffset);
