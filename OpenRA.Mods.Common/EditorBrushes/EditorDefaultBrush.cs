...
namespace OpenRA.Mods.Common.Widgets
{
	...
	public sealed class EditorDefaultBrush : IEditorBrush
	{
		...
		public EditorActionManager GetEditorActionManager()
		{
	...
	sealed class ChangeSelectionAction : IEditorAction
	{
			...
			EditorSelection previousSelection)
		{
			...
			Text = selection.Area != null ? $"Selected area {selection.Area.TopLeft.X},{selection.Area.TopLeft.Y} ({selection.Area.BottomRight.X - selection.Area.TopLeft.X},{selection.Area.BottomRight.Y - selection.Area.TopLeft.Y})" :
				selection.Actor != null ? $"Selected actor {selection.Actor.ID}" :
				"Cleared selection";
		}
